...
var slideTime; 
var stop=false;	
function start(){if(stop===false){slideTime=setTimeout(function(){start();},pause);animeslide('next');
$('#rotator').hover(function(){clearTimeout(slideTime);stop=true;},function(){stop = false;function(){start();},pause);animeslide('next');});}}
