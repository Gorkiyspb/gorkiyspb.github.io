...
var slideTime; 
var stop=false;	
function start(){if(!stop){slideTime=setTimeout(function(){animeslide('next');},pause);start();}
else{$('#rotator').hover(function(){clearTimeout(slideTime);stop=true;},function(){stop = false; start();});}}
start();});
